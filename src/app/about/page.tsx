export default function About() {
    return (
        <main        
        style={{
            backgroundImage: 'url("https://i.ibb.co/yP48STC/space2.jpg")',
    ...
    >
            ...
            <div className="flex flex-col items-center m-5 sm:m-0  glass sm:w-1/2 rounded-xl shadow-xl shadow-black">
                <div className="flex flex-col items-center rounded-xl p-5 sm:p-10">
